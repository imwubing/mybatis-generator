...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_SELECT_ONE_BY_SELECTIVE_STATEMENT_ID,
    ...
    protected void calculateXmlAttributes() {
        ...
        setSelectBySelectiveStatementId("selectByCondition"); //$NON-NLS-1$
        setSelectOneBySelectiveStatementId("selectOneByCondition"); //$NON-NLS-1$
    ...
    public void setSelectOneBySelectiveStatementId(String s) {
        internalAttributes.put(InternalAttribute.ATTR_SELECT_ONE_BY_SELECTIVE_STATEMENT_ID, s);
    }
    ...
    public String getSelectBySelectiveStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_SELECT_BY_SELECTIVE_STATEMENT_ID);
    }

    public String getSelectOneBySelectiveStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_SELECT_ONE_BY_SELECTIVE_STATEMENT_ID);
    }
